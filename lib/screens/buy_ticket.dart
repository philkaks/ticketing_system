...
import 'package:ticketing_system/payments.dart';
...
class BuyTicket extends StatefulWidget {
  ...
  BuyTicket(this.title, this.price, {Key? key}) : super(key: key);
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        //!TO add movie name
                        Text(widget.title, style: kMainTextStyle),
                        const Text('NO SEAT SELECTION REQUIRED',
                        ...
                        Row(
                          children: <Widget>[
                            Text('PROCEED TO PAY', style: kMainTextStyle),
              ...
              children: <Widget>[
                ...
                InkWell(
                  onTap: () => Navigator.push(
                      context,
                      SlideRightRoute(
                          page: Payments(movies[widget.index].price))),
                  child: Container(
                    padding: const EdgeInsets.symmetric(
